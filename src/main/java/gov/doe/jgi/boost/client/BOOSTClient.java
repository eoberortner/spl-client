	...
	public String saveJobReport(
		...
		if(!Files.exists(jobOutputDir)) {
			...
			if(jobReport.has("provenance")) {
				...
				FileUtils.writeStringToFile(
						Paths.get(jobOutputDir.toString(), jobUUID + "-input-PROV.sbol.xml").toFile(), 
						boostProvInputDocument);
				//System.out.println(Paths.get(jobOutputDir.toString(), jobUUID + "-input-PROV.sbol.xml"));
				...
				FileUtils.writeStringToFile(
						Paths.get(jobOutputDir.toString(), jobUUID + "-output-PROV.sbol.xml").toFile(), 
						boostProvOutputDocument);
				//System.out.println(Paths.get(jobOutputDir.toString(), jobUUID + "-output-PROV.sbol.xml"));
			}
